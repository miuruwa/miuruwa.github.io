...
export const termsOfService: {
    translations: Translations.Translate<Pages.TOS>
} = {
    translations: {
        eng: {
            ...
            note: {
                headline: "Important",
                description: "Ordering artwork from me, you agree to my terms of service and in the future you cannot make claims against the document.",
            },
            terms: [
                {
                    headline: "Payment",
